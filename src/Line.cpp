...
Line::TO_DO Line::decreaseNbr(int val, int idBlock){  // updates and looks for locked cells
    ...
    if (nbrPossible[val][idBlock] == 0){
		switch(getIFullLine(nbrPossible[val],idBlock)) {
			case 0 : return LOCK_SQUARE0;
			case 1 : return LOCK_SQUARE1;
			case 2 : return LOCK_SQUARE2;
		}
    }
